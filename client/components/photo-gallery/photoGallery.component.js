...
export class PhotogalleryComponent {
  ...
  /*@ngInject*/
  constructor($document, $timeout, $q, $templateCache) {
    this.images = [
      {
        thumb: 'http://www.w3schools.com/html/pic_mountain.jpg', img: 'http://www.w3schools.com/html/pic_mountain.jpg'
      },
      {
        thumb: 'http://www.w3schools.com/html/pic_mountain.jpg', img: 'http://www.w3schools.com/html/pic_mountain.jpg'
      }
...
export default angular.module('directives.photogallery', [])
  .component('photogallery', {
    ...
    // controller: PhotoGalleryComponent,
    restrict: 'EA',
    scope: {
      images: '=',
      thumbsNum: '@',
